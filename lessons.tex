...
For this exercice, you will create a new function called \mcode{testPlot} in a file name \verb|testPlot.m|, as follows:
\begin{lstlisting}
function testPlot
  % exercise function
...
\begin{enumerate}
  ...
  \item \mcode{plot} can take a \textbf{string} input defining the stype of the line.
...
\todo[inline]{imagesc, hist, subplot}
